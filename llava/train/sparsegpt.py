...
class SparseGPT:
    ...
    def fasterprune(
        ...
        pretrain_weights = pretrain_weights.to(dtype=W.dtype)
        ...
        for i1 in range(0, self.columns, blocksize):
            ...
            if use_tops == False:
                if prunen == 0: 
                    if mask is not None:
                        ...
                        importance_score = 0.8 * param_changes_normalized + 0.2 * tmp_normalized
                        # importance_score = param_changes_normalized
                        # importance_score = tmp_normalized
            ...
            for i in range(count): # count 128
                ...
                q[mask_indices] = pretrain_weights[:, i1 + i][mask_indices].to(q.dtype)
