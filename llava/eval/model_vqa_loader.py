...
def eval_model(args):
    ...
    if args.masked_param_path:
        dare_model_params = torch.load(args.masked_param_path,  map_location=lambda storage, loc: storage.cuda())
    ...
    #     masked_param_dict = torch.load(args.masked_param_path,  map_location="cpu")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--masked-param-path", type=str, default=None)
    # parser.add_argument("--masked-param-path", type=str, default="/your_data_path//code/LLaVA/checkpoints/llava-v1.5-7b-tune12layers-okvqa-v4-1e-4/grafted_model_params_sparsity10_v1.pth")
    parser.add_argument("--image-folder", type=str, default="/mnt/workspace/workgroup/honghaochen/datasets/llava_eval/textvqa/train_images")
    parser.add_argument("--question-file", type=str, default="/mnt/workspace/workgroup/honghaochen/datasets/llava_eval/textvqa/llava_textvqa_val_v051_ocr.jsonl")
    parser.add_argument("--answers-file", type=str, default="/your_data_path//data/textvqa/answers/llava-v1.5-7b-lora-textvqa-instruction-sparsity-20.jsonl")
